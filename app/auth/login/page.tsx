    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary">MoneySync</h1>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            ...
            <p className="text-neutral-600 text-sm mt-2">Enter your credentials to access your account</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="remember" className="text-sm text-neutral-600 ml-2">
                  Remember me
                </label>
              </div>
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border rounded-lg hover:bg-neutral-50 transition-colors"
              >
